...
import 'reviw_list.dart';




const String _kGalleryAssetsPackage = 'flutter_gallery_assets';
const String _kAsset0 = 'assets/unpin.png';
const String _kAsset1 = 'assets/unpin.png';
const String _kAsset2 = 'assets/unpin.png';

  String logazul = "assets/logoazul.png";
  String logblanc = "assets/logoblanco.png";
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      ...
      //Lista en la parte derecha de la aplicacón

      drawer: new Drawer(
        child: new Column(children: <Widget>[new Expanded(child: new ListView(
          children: <Widget>[
            new UserAccountsDrawerHeader(
                //accountName: const Text('Educar'),
                //accountEmail: const Text('www.Educar.com'),
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage(logblanc),
                    ),
                ...
                /*currentAccountPicture: const CircleAvatar(
                  backgroundImage: const AssetImage("assets/loading.png"),
                )*/
            ),
